          ...
          (
            <div className='w-11/12 max-w-[500px] p-4 lg:p-8 mx-auto  flex flex-col' >
              ...
              <form onSubmit={handleOnSubmit}>
                ...
                <button type='submit' className='w-full p-3 font-medium mt-6 rounded-lg bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] text-richblack-900 hover:scale-95 transition-all duration-200 drop-shadow-[2px_2px_rgba(255,255,255,0.18)] hover:drop-shadow-none' >
                  {
