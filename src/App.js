...
import CompilerApp from "./pages/CodeCompiler/CodeCompiler";
import AdminDashboard from "./pages/Certificate/pages/AdminDashboard";
import CertificateRequestForm from "./pages/Certificate/pages/Home";
import InternshipApplicationForm from "./pages/Internship/index.jsx";
...
function App() {
  ...
  // Hide Navbar on '/compile' route
  const showNavbar = location.pathname !== "/compile";
  ...
  return (
    <div className="bg-richblack-900 w-screen min-h-screen flex flex-col font-inter">
      ...
      <Routes>
        ...
        />
        <Route path="/compile" element={<CompilerApp />} />
        ...
        >
          ...
          <Route
            ...
            element={<PrivateStudentRoute route={<CertificateRequestForm />} />}
          />
          ...
          <Route
            path="certificate"
            element={<PrivateInstructorPage route={<AdminDashboard />} />} // Add Certificate route here
          />
          {/* {
