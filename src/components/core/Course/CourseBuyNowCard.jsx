      ...
      <div className='px-4' >
        ...
        <div className='flex flex-col gap-4' >
          <button
            ...
            className='bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] text-richblack-900 hover:scale-95 transition-all duration-200 drop-shadow-[2px_2px_rgba(255,255,255,0.18)] hover:drop-shadow-none py-2 px-5 rounded-md font-semibold text-richblack-900'
          >
            {
        ...
        <div className='mx-auto text-center'>
          <button className='py-6 text-custom-blue' onClick={handleShare} >
