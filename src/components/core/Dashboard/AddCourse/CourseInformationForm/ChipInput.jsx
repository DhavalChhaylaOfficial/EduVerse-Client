  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex flex-wrap gap-y-1 mb-2' >
        {
          chips.map((chip, ind) => (
            <div key={ind} className='flex items-center gap-x-2 bg-blue-25 rounded-full px-2 py-1 text-sm text-richblack-700 m-1 ' >
              {chip}

              <button
                type='button'
                className='text-richblack-700 hover:outline outline-richblack-700 rounded-full'
      ...
      <button
        ...
        className='font-semibold text-blue-25 text-left mt-2'
      >
        Add
      </button>
