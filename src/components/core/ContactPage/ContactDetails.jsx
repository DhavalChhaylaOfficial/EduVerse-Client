...
const contactDetails = [
  {
    ...
    details: "eduvers.portal@gmail.com",
  },
  {
    icon: "BiWorld",
    heading: "Visit us",
    description: "Come and say hello at our office HQ.",
    details: "CHARUSAT Campus, Off. Nadiad-Petlad Highway, <br />Changa-388421",
  },
  {
    icon: "IoCall",
    heading: "Call us",
        ...
        contactDetails.map((data, ind) => {
          ...
          return (
            <div className='flex flex-col gap-[2px] text-richblack-200 p-3 text-sm' >
              ...
              <p className="font-medium" dangerouslySetInnerHTML={{ __html: data.details }}></p>
