...
const ReviewCard = ({ review }) => {
  ...
  return (
    <div className={`w-[300px] flex flex-col gap-y-2 px-3 py-3 bg-richblack-800 text-white rounded-lg shadow-[10px_-5px_10px_-5px] shadow-blue-200 overflow-hidden
    ...
    `} >
      ...
      <div className='flex flex-col justify-between h-full'>
        ...
        <div className='flex gap-x-2 items-center'>
          <p className='font-semibold' style={{ color: "#00e1ff" }}>{review.rating}</p>
